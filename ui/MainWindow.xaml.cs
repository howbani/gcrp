...
using TreeBased.Coverage;
using TreeBased.Properties;
using System.Windows.Media;
using System.Windows.Threading;
using TreeBased.Forwarding;
using TreeBased.ExpermentsResults.Energy_consumptions;
using TreeBased.ExpermentsResults.Lifetime;
using TreeBased.ControlPlane.NOS.TC;
using TreeBased.ControlPlane.NOS.TC.subgrapgh;
using TreeBased.DataPlane.NeighborsDiscovery;
using TreeBased.ControlPlane.NOS.FlowEngin;
using TreeBased.ui.conts;
using TreeBased.Charts.Intilization;
using TreeBased.ControlPlane.NOS.Visualizating;
...
namespace TreeBased.ui
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void btn_send_query_click(object sender, RoutedEventArgs e)
        {
            MenuItem item = sender as MenuItem;
            string header = item.Header.ToString();
            PublicParameters.myNetwork[1].DissemenateData();
        }
